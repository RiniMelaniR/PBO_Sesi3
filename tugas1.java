...
public class tugas1 {
  ...
  public static void main(String[] args) {
    ConanCariAnggota jebolanDon = new ConanCariAnggota("Ahmad Sulaeman", 42, "Nevada", 12000000);
    ConanCariAnggota jebolanUnderboss = new ConanCariAnggota("Rian Febriana R", 30, "Nevada", 1500000 );
    ConanCariAnggota jebolanCapo = new ConanCariAnggota("Sule", 25, "California", 900000);
    ConanCariAnggota jebolanNusaPutra = new ConanCariAnggota("Rini Melani R", 20, "Sukabumi", 500);
  ...
  public static String getWarning(ConanCariAnggota anggota) {
    ...
    switch(syndicate.toLowerCase()) {
      ...
      default:
        return anggota.nama + " tidak mencurigakan karena dia tidak termasuk kedalam ciri-ciri mafia.";
    }
  }
